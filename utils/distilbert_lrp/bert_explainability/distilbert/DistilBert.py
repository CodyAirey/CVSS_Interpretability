...
class DistilBertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        # Save a detached copy for later inspection; only register hook when grads are enabled
        self.save_attn(attention_probs.detach())
...
class DistilBertModel(DistilBertPreTrainedModel):
    def __init__(self, config):
        ...
        self.pooler = DistilBertPooler(config)
...
if __name__ == '__main__':
    ...
    model = DistilBertSelfAttention(Config(1024, 4, 0.1))
