...
# Local Imports
from utils.distilbert_lrp.bert_explainability.layers_ours import *
from utils.distilbert_lrp.bert_explainability.distilbert.DistilBert import DistilBertModel
from utils.distilbert_lrp.bert_explainability.distilbert.model_utils import PaddedSequence
...
class DistilBertForSequenceClassification(DistilBertPreTrainedModel):
    def __init__(self, config):
        ...
        self.config.type_vocab_size = 2  # Set a default token type vocabulary size
        self.config.layer_norm_eps = 1e-12
        self.config.hidden_dropout_prob=0.1
        self.config.attention_probs_dropout_prob=0.1
        self.config.intermediate_size = config.hidden_dim
        self.config.hidden_act = config.activation
    ...
    def get_input_embeddings(self):
        # Return the actual embeddings layer (word_embeddings)
...
class BertClassifier(nn.Module):
    ...
    def __init__(self,
        ...
        bert = DistilBertForSequenceClassification.from_pretrained(bert_dir, num_labels=num_labels)
...
if __name__ == '__main__':
    ...
    model = DistilBertForSequenceClassification.from_pretrained('/home/cody/.cache/huggingface/hub/models--distilbert-base-cased/snapshots/6ea81172465e8b0ad3fddeed32b986cdcdcffcf0', num_labels=2)
